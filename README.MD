...
To simplify setup and execution, the project includes a `run.sh` script that builds the project and starts all required
...
- `PATCH /api/orders/{orderId}` – Cancel an order (**Not implemented yet**)
